...
<source 
            src="https://ugc-idle.s3-us-west-2.amazonaws.com/est_a8973a827652539f7b679f4867a96835.mp4" />
</video>"""
...
def get_chatassistant_chain_GPT():
    ...
    vectorstore_GPT = PineconeVectorStore(index_name="001-realavatar-andre", embedding=embeddings_model)
    set_debug(True)
...
def get_chatassistant_chain_Llama():
    embeddings = OpenAIEmbeddings()
    vectorstore_Llama = PineconeVectorStore(index_name="001-realavatar-andre", embedding=embeddings)
    set_debug(True)
